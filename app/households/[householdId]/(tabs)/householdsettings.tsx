...
const styles = StyleSheet.create({
  page: { flexGrow: 1, backgroundColor: colors.background, paddingHorizontal: 24, paddingTop: 24, paddingBottom: 48 },
  header: { marginBottom: 48 },
  eyebrow: { fontSize: 13, fontWeight: "800", letterSpacing: 4, color: colors.tertiary, marginBottom: 10 },
  title: { fontSize: 48, lineHeight: 56, fontWeight: "900", color: colors.dark, letterSpacing: -2 },
  titleUnderline: { width: 92, height: 4, borderRadius: 99, backgroundColor: colors.secondary, marginTop: 14 },
  content: { flexDirection: "row", gap: 44, alignItems: "flex-start" },
  mainColumn: { flex: 1, gap: 36 },
  sideColumn: { width: 280, gap: 32 },
  sectionCard: { backgroundColor: colors.surface, borderRadius: 28, padding: 40 },
  sectionHeader: { flexDirection: "row", alignItems: "center", gap: 14, marginBottom: 36 },
  sectionTitle: { fontSize: 25, fontWeight: "900", color: colors.dark },
  gridTwo: { flexDirection: "row", flexWrap: "wrap", gap: 28 },
  addressGrid: { flexDirection: "row", flexWrap: "wrap", gap: 24 },
  fieldWrap: { width: "47%", minWidth: 190 },
  fieldWide: { width: "62%" },
  fieldLabel: { fontSize: 12, fontWeight: "800", color: colors.neutral, marginBottom: 10 },
  inputBox: { height: 56, borderRadius: 10, paddingHorizontal: 16, backgroundColor: "#EDE8E4", flexDirection: "row", alignItems: "center", gap: 8 },
  inputMuted: { backgroundColor: "#F1EAE4" },
  inputReadOnly: { backgroundColor: "#F1EAE4", opacity: 0.8 },
  inputPrefix: { fontSize: 16, fontWeight: "500", color: colors.dark },
  inputText: { flex: 1, fontSize: 16, fontWeight: "500", color: colors.dark, padding: 0 },
  inputTextMuted: { color: colors.borderSoft, fontWeight: "700" },
  inputTextReadOnly: { color: colors.textMuted },
  membersList: { marginTop: 16, gap: 12 },
  memberRow: { paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: colors.borderSoft },
  memberName: { fontSize: 14, fontWeight: "600", color: colors.text },
  membersCard: { backgroundColor: colors.whiteSoft, borderRadius: 28, padding: 28, minHeight: 300 },
  membersHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  membersTitle: { fontSize: 21, fontWeight: "900", color: colors.dark },
  memberCountPill: { backgroundColor: colors.surfaceSoft, borderRadius: 99, paddingHorizontal: 14, paddingVertical: 6 },
  memberCountText: { fontSize: 13, fontWeight: "800", color: colors.primary },
  emptyMembersState: { flex: 1, justifyContent: "center", alignItems: "center", paddingVertical: 52 },
  emptyMembersText: { fontSize: 14, textAlign: "center", color: colors.textMuted, fontWeight: "600" },
  inviteButton: { height: 62, borderRadius: 32, backgroundColor: colors.primary, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10, shadowColor: colors.primary, shadowOpacity: 0.25, shadowRadius: 18, shadowOffset: { width: 0, height: 10 }, elevation: 4 },
  inviteButtonText: { color: colors.whiteSoft, fontSize: 16, fontWeight: "800" },
  actions: { flexDirection: "row", gap: 24, flexWrap: "wrap", marginTop: 24 },
  saveButton: { minWidth: 180, height: 62, borderRadius: 31, backgroundColor: colors.primary, alignItems: "center", justifyContent: "center" },
  saveButtonText: { color: colors.whiteSoft, fontSize: 15, fontWeight: "800" },
  discardButton: { minWidth: 180, height: 62, borderRadius: 31, backgroundColor: "#E6E1DD", alignItems: "center", justifyContent: "center" },
  discardButtonText: { color: colors.tertiary, fontSize: 15, fontWeight: "800" },
  deleteButton: { flexDirection: "row", alignItems: "center", gap: 10, marginTop: 8, marginLeft: 28 },
  deleteText: { fontSize: 16, fontWeight: "800", color: colors.danger },
  overlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.4)", justifyContent: "center", alignItems: "center" },
  modalCard: { backgroundColor: colors.surface, borderRadius: 12, padding: 24, width: 340, gap: 8 },
  modalTitle: { fontSize: 18, fontWeight: "600", color: colors.text },
  modalSubtitle: { fontSize: 14, color: colors.textMuted, marginBottom: 8, lineHeight: 22 },
  modalBold: { fontWeight: "800", color: colors.text },
  modalActions: { flexDirection: "row", justifyContent: "flex-end", gap: 8, marginTop: 8 },
  cancelButton: { borderRadius: 8, paddingHorizontal: 16, paddingVertical: 10, borderWidth: 1, borderColor: colors.borderSoft },
  cancelText: { fontSize: 14, color: colors.text },
  confirmDeleteButton: { borderRadius: 8, paddingHorizontal: 16, paddingVertical: 10, backgroundColor: colors.danger },
  confirmDeleteText: { 
    fontSize: 14, 
